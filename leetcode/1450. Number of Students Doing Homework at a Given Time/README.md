...
<p>Given two integer arrays <code>startTim</code> and <code>endTime</code> and given an integer <code>queryTime</code>.</p>
...
<p>Return the number of students doing their homework at time <code>queryTime</code>. More formally, 
  return the number of students where <code>queryTime</code> lays in the interval <code>[startTime[i], endTime[i]]</code> inclusive.</p>
